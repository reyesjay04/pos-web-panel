...
if (usernameexistCREW($username)) {
	...
	if (emailexistCREW($email)) {
		...
		if (contactnumberexistCREW($contactnumber)) {
			...
			(`user_level`,`full_name`,`username`,`password`,`contact_number`,`email`,`position`,`gender`,`active`,`guid`,`store_id`,`uniq_id`,`pwd`,`synced`,`created_at`,`updated_at`,`user_code`) VALUES (
			'$role','$fullname','$username','$password_crypt','$contactnumber','$email','$role','$gender',1,'$guid','$store','$uniq_id','$password','Unsynced','$datenow','$datenow','$usercode')";
